...
class ArtistsManagerTest {
    ...
    void validateArtistName() throws DBException {
        ...
        DBException artistException1 = Assertions.assertThrows(DBException.class, () -> {
           artistManager.validateName(incorrectNameShort);}, "Artist's first name cannot be longer than 50 or shorter than 1 character!");
        Assertions.assertEquals("Artist's first name cannot be longer than 50 or shorter than 1 character!", artistException1.getMessage());
        ...
        DBException quoteException2 = Assertions.assertThrows(DBException.class, () -> {
            artistManager.validateName(incorrectNameLong);}, "Artist's first name cannot be longer than 50 or shorter than 1 character!");
        Assertions.assertEquals("Artist's first name cannot be longer than 50 or shorter than 1 character!", quoteException2.getMessage());
    }
    ...
    void add() throws DBException {
        ...
        DBException artistException = Assertions.assertThrows(DBException.class, () -> {
            artistManager.add(artist);}, "You cannot add a new artist containing ID. ID is autogenerated");

        Assertions.assertEquals("You cannot add a new artist containing ID. ID is autogenerated", artistException.getMessage());
